...
//Tests
bookIsDay(100, [15,20,20,15,10,30,45]); //should return 6
bookIsDay(100, [10,10,10,10,10,10,10]); //should return 3
bookIsDay(3, [1,1,1,1,1,1,1]); //should return 3
bookIsDay(77, [11,11,11,11,11,11,10]); //should return 1
bookIsDay(1, [0,0,0,0,0,0,1]); //should return 7
bookIsDay(50, [10,1,10,1,10,1,10]); //should return 1
bookIsDay(10, [5,1,1,1,1,1,5]); //should return 6
